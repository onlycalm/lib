...
//-----------------------------------------------------------------------------
//普通函数
extern dtc WrIicSerBy(const byte cbySlvAdr, const byte cbyRegAdr, const word cwByAmt, byte* const cpabyDat);
extern dtc WrIicSerWd(const byte cbySlvAdr, const byte cbyRegAdr, const word cwWdAmt,
                      const EEndn ceEndn, word* const cpawDat);
extern dtc RdIicSerBy(const byte cbySlvAdr, const byte cbyRegAdr, const word cwByAmt, byte* const cpabyDat);
extern dtc RdIicSerWd(const byte cbySlvAdr, const byte cbyRegAdr, const word cwWdAmt,
                      const EEndn ceEndn, word* const cpawDat);
extern dtc WrIicSerByChk(const byte cbySlvAdr, const byte cbyRegAdr, const word cwByAmt, byte* const cpabyDat);
extern dtc WrIicSerWdChk(const byte cbySlvAdr, const byte cbyRegAdr, const word cwWdAmt,
                         const EEndn ceEndn, word* const cpawDat);
extern dtc RdIicSerByChk(const byte cbySlvAdr, const byte cbyRegAdr, const word cwByAmt, byte* const cpabyDat);
extern dtc RdIicSerWdChk(const byte cbySlvAdr, const byte cbyRegAdr, const word cwWdAmt,
                         const EEndn ceEndn, word* const cpawDat);
extern dtc WrIicSerByRcl(const byte cbySlvAdr, const byte cbyRegAdr, const word cwByAmt, byte* const cpabyDat);
...
extern dtc ModWdBit(const byte cbySlvAdr, const byte cbyRegAdr, const byte cbyMd, const EEndn ceEndn, const word cwMap);
